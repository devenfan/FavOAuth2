...
<head>
  ...
  <script type="text/javascript">
  	function userAuthorize(){
  		$.ajax({
			type:'POST',
			url:'<%=basePath%>oauth2/userAuthorize',
			data:$("#authZForm").serialize(),
			dataType:'json',
			timeout: 50000,
			cache: false,
			async: false,
		...
		<div class="oauth_wrap">
	    	<div class="oauth_header clearfix">
	     	 	...
	     	 	<p class="login_account">
                    <span class="account_name">${favUser.username }</span>
                    <span class="vline">|</span>
                    <span>
                        <a href="http://app.weibo.com/my" target="_blank">我的应用</a>
                    </span>
                    <span class="vline">|</span>
	        			...
	        			<div class="oauth_main_content clearfix">
	        				<div class="app_info clearfix">
	        					<div class="app_info_main clearfix">
		        					...
		        					<div class="app_intro">
		        						<h3><a href="${favWebApp.webUrl}" target="_blank">${favWebApp.webName}</a></h3>
	        				...
	        				<div class="oauth_info clearfix">
	        					<div class="oauth_list">
	        						<div class="list_tit">将允许<a href="${favWebApp.webUrl}" target="_blank">${favWebApp.webName}</a>进行以下操作：</div>
        							<ul class="do_list">
			            				<li>
	        					...
	        					<div class="oauth_info_plus">
				                    ...
				                    <%--<div class="sele_des">--%>
				                    	<%--为了模拟方便，设置所有人都可以看到你在 <em class="sele_des_em">${favWebApp.webName}</em> 上的动态--%>
				                    <%--</div>--%>
	                			</div>
	                		</div>
	        			</div>
